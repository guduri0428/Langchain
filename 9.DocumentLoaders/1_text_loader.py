...
print(docs[0].page_content) # page content of first document
...
# The poem celebrates the game of cricket, describing its beauty and excitement from the perspective of players, fans, and the essence of the 
# sport itself. The poet captures the thrill of the game, from the toss to the final ball, highlighting the emotions, strategies, and timeless moments that make cricket a beloved sport around the world. The poem also pays tribute to the legends and heroes of the game, as well as the joy and camaraderie that cricket brings to players and fans alike. Ultimately, the poem celebrates the spirit and magic of cricket, describing it as more than just a sport but a timeless thread that unites people and generations.
# (.venv) 
# Lenovo@DESKTOP-GNHJGV0 MINGW64 /f/Gen AI Repos/Langchain/9.DocumentLoaders (main)